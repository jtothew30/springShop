	  ...
	  <div class="row">
	    ...
	    <form name="acct"  method="post" action="acct_change.do">
	       ...
	       <div class="control-group">
	         <div class="form-group floating-label-form-group controls">
	           <label>성별</label>
	           	<input type="radio" class="form-control" name="gender" value="male" disabled="disabled">남자
	 	  	  	<input type="radio" class="form-control" name="gender" value="female" disabled="disabled">여자	         
