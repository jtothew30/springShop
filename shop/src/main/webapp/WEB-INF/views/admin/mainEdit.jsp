		...
		<div class="callout primary">
			<div class="row column">
					<table>
						<thead>
						  <tr>
							<th width="10px">tag</th>
							<th width="250px">etitle</th>
							<th width="250px">escript</th>
							<th width="6px">xpath</th>
							<th width="6px">ypath</th>
							<th width="6px">pbno</th>
							<th width="6px">flag</th>
							<th width="6px">Edit</th>
							<th width="6px">Dele</th>
						  </tr>							
						</thead>
						<tbody>
						<!-- TODO -->
				<c:forEach items="${elist}" var="tlist">
						  <tr>
							<td>${tlist.tag}</td>
							<td>${tlist.etitle}</td>
							<td>${tlist.escript}</td>
				...
				<form action="mainEventEdit.do" method="post">
					<label for="tag"><b>이벤트태그구분자:</b>
						<c:forEach items="${tlist}" var="tlist">[ ${tlist.tag} ]</c:forEach>
					</label>
