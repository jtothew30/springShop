...
<body>
	...
	<div class="off-canvas-content" data-off-canvas-content>
		...
		<div class="callout primary">
			<div class="row column">
				<form name="productInsertForm" action="productInsert.do"
					method="post">
					<p>
			...
			<p>
				제조사명:<input name="brand" type="text">
			</p>
			<div class="row column">
				<p>
					입고가격:<input name="inprice" type="text">
				</p>
			</div>
			<div class="row column">
				<p>
					판매가격:<input name="outprice" type="text">
				</p>
			</div>
			<div class="row column">
				<p>
					카테고리1:<input name="category1" class="category1" type="text">
				</p>
			</div>
			<div class="row column">
				<p>
					카테고리2:<input name="category2" class="category2" type="text">
				</p>
			</div>
			<div class="row column">
				<p>
					카테고리3:<input name="category3" class="category3" type="text">
				</p>
			</div>
			<div class="row column">
				<p>
					옵션:<input name="options" type="text">
				</p>
			</div>
			<div class="row column">
				<p>
					부가설명:
					<textarea name="script" rows="3"></textarea>
				</p>
			</div>
