...
<body>
	...
	<div class="off-canvas-content" data-off-canvas-content>
		...
		<div class="callout primary">
			<div class="row column">
				<form name="boardInsertForm" action="boardUpdate.do" method="post" enctype="multipart/form-data">
					<input type="hidden" name="pbno" value="${pb.pbno}">
					<div class="row column">
						<p>
							글 제목:<input value="${pb.title}" id="title" name="title" type="text">
						</p>
					</div>
					<div class="row column">
						<p>
							원 가격:<input value="${pb.price}"name="price" type="text">
						</p>
					</div>
					<div class="row column">
						<p>
							할인가격:<input value="${pb.event}" name="event" type="text">
						</p>
					</div>
					<div class="row column">
						<p>
							판매량:<input value="${pb.totalsales}" name="totalsales" type="text">
						</p>
					</div>
					<div class="row column">
						<p>
