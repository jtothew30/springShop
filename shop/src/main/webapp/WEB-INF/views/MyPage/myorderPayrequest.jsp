      ...
      <ul class="pagination-pointed pagination text-center" role="navigation" aria-label="Pagination">        
        ...
        <c:forEach begin="${paging.beginPage}" end="${paging.endPage}" var="index">
          <c:choose>
            ...
            <c:otherwise>
              <li><a class="pagination-pointed-button" href="myorder.do?pagePr=${index}&tabs=payrequest&todate=${todate}&fromdate=${fromdate}" aria-label="Page ${index}">${index}</a></li>
            </c:otherwise>
          </c:choose>
        </c:forEach>        
