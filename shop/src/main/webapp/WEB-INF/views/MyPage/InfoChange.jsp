...
<body>
    <div class="container">
	  <div class="row">
	    ...
	    <br>
	    <h3>회원정보수정</h3>
	    <form name="acct"  method="post" action="${pageContext.request.contextPath}/account/acct_InfoChange.do">
	       ...
	       <div class="control-group">
	         <div class="form-group floating-label-form-group controls">
	           <label>패스워드 확인</label>
	           <input type="password" class="form-control" placeholder="패스워드 확인" id="pw2" onkeyup="pwCheck();" required>
		   ...
		   <div class="form-group">
	         <button type=button class="btn btn-success" id="sendMessageButton" onclick="check();">수정완료</button>
